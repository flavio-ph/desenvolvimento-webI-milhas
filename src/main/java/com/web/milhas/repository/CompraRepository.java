...
public interface CompraRepository extends JpaRepository<CompraEntity, Long> {
        ...
        @EntityGraph(attributePaths = { "cartao", "cartao.programaPontos", "cartao.usuario" })
        org.springframework.data.domain.Page<CompraEntity> findByCartaoId(Long cartaoId,
                        org.springframework.data.domain.Pageable pageable);

        @EntityGraph(attributePaths = { "cartao", "cartao.programaPontos", "cartao.usuario" })
        org.springframework.data.domain.Page<CompraEntity> findByCartaoUsuarioId(Long usuarioId,
                        org.springframework.data.domain.Pageable pageable);
